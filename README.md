...
└── README.md
🎮 How to Use
Home Page: Enter your name, select a topic and difficulty level
Quiz: Answer 10 questions within 15 seconds each
Results: View your score, accuracy, and earned coins
Review: Check all answers with explanations
